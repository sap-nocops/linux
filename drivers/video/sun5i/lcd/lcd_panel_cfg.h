...
//hxm add for 65185
extern void LCD_eink_65185_vcom_on();
extern void LCD_eink_65185_vcom_off();
extern void LCD_eink_65185_wakeup_on();
extern void LCD_eink_65185_wakeup_off();
extern void LCD_eink_65185_powerup_on();
extern void LCD_eink_65185_powerup_off();
//end
...
extern void LCD_eink_main_pwr_on(__u32 sel);
extern void LCD_eink_main_pwr_off(__u32 sel);
extern void LCD_eink_vneg_on(__u32 sel);
extern void LCD_eink_vneg_off(__u32 sel);
extern void LCD_eink_vpos_on(__u32 sel);
extern void LCD_eink_vpos_off(__u32 sel);
extern void LCD_eink_ud_on(__u32 sel);
extern void LCD_eink_ud_off(__u32 sel);
extern void LCD_eink_rl_on(__u32 sel);
extern void LCD_eink_rl_off(__u32 sel);
extern void LCD_eink_vgg_on(__u32 sel);
extern void LCD_eink_vgg_off(__u32 sel);
extern void LCD_eink_vcom_on(__u32 sel);
extern void LCD_eink_vcom_off(__u32 sel);
