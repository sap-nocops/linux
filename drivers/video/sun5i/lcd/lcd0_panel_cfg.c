...
//hxm add
//extern int tps65185_power_set(int up_or_down);
//extern int tps65185_vcom_set(int vcom_mv);
extern  void papyrus_hw_send_powerdown_led();
extern  void papyrus_hw_send_powerup_led();
//end
...
static __s32 LCD_open_flow(__u32 sel)
{
	...
	//hxm add
	//tps65185_power_set(1);
	papyrus_hw_send_powerup_led();
	//LCD_OPEN_FUNC(sel, LCD_eink_65185_vcom_on, 0);
	//LCD_OPEN_FUNC(sel, LCD_eink_65185_wakeup_on, 0);
	//LCD_OPEN_FUNC(sel, LCD_eink_65185_powerup_on, 10);

	//end
#if 0
	LCD_OPEN_FUNC(sel, LCD_eink_main_pwr_on, 0);
	LCD_OPEN_FUNC(sel, LCD_eink_vneg_on, 0);
	LCD_OPEN_FUNC(sel, LCD_eink_vpos_on, 0);
	LCD_OPEN_FUNC(sel, LCD_eink_ud_on, 0);
	LCD_OPEN_FUNC(sel, LCD_eink_rl_on, 0);
	LCD_OPEN_FUNC(sel, LCD_eink_vgg_on, 0);
	LCD_OPEN_FUNC(sel, LCD_eink_vcom_on, 0);
#endif
...
static __s32 LCD_close_flow(__u32 sel)
{
	...
	//hxm add
	// tps65185_power_set(0);
	papyrus_hw_send_powerdown_led();
	// LCD_OPEN_FUNC(sel, LCD_eink_65185_powerup_off, 0);
	// LCD_OPEN_FUNC(sel, LCD_eink_65185_wakeup_off, 0);
	// LCD_OPEN_FUNC(sel, LCD_eink_65185_vcom_off, 0);
	//end
	...
	LCD_CLOSE_FUNC(sel, LCD_eink_vcom_off, 0);
#endif
