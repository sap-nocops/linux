...
#define GTP_GPIO_AS_INPUT(gpiohandler,pin)		do{\
                                          			gpio_set_one_pin_io_status(gpiohandler,0,pin);\
                                        		}while(0)
#define GTP_GPIO_AS_INT(gpiohandler,pin)      		do{\
                                          			GTP_GPIO_AS_INPUT(gpiohandler,pin);\
                                        		}while(0)
...
static u16 screen_max_x=0;
static u16 screen_max_y=0;
