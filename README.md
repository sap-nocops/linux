...
- Orange Pi PC 2
- Orange Pi 3
- PinePhone Dev Phone/Braveheart
- TBS A711 Tablet
...
- [PinePhone] WiFi, Bluetooth, Display Panel, Modem Audio, Fixes here and there
...
Get kernel from this repository and checkout the latest orange-pi-5.7 branch.
